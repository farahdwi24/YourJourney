...
public class PrayPlaceAdapter extends RecyclerView.Adapter<PrayPlaceAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_pray_place, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements OnMapReadyCallback {
        ...
        private ModelPrayPlace mMapLocation;
        ...
        public void setMapLocation(ModelPrayPlace mapLocation) {
